...
feature "user views books index", js: true do
  ...
  scenario "books are organized alphabetically", js: true do
    visit "/"
  ...
  scenario "long book descriptions are truncated", js: true do
    visit "/"

    expect(page).not_to have_content "rebellions armed with sticks"
  end

  scenario "average book ratings are displayed", js: true do
